...
1 つのボードが 2 つのポートで同時に応答することもあります。オンボードのネイティブ USB と、同じ UART に付いた CH340 を持つ ESP32-S3 は、どちらからも同じ MAC を読みます。そこで各リンクは 2 通りで公開されます。ボードの名前そのものと、その名前にトランスポートを付けた、特定の経路を指す名前です。
